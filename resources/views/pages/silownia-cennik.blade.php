...
@section('content')
 ...
 <div id="cennik" style="padding-top:120px; width:100%; display: inline-block;" class="container">
  ...
  <div style="font-family: 'Pragati Narrow', sans-serif; margin-bottom: 40px;" class="text-center">
      <h1 style="font-size: 55px;">Cennik - <strong> siłownia funkcjonalna + cardio + ścianka wspinaczkowa </strong></h1>
      ...
      <div class="panel panel-default text-center">
        ...
        <div class="panel-cena-body">
          ...
          <p style="font-size: 85%;"><strong>Kobiety i młodzież do 18 lat:</strong> 90zł </p>
           ...
           <p style="padding-top: 5px;padding-bottom: 5px; color: white; font-size: 100%; background-color: silver;"> Siłownia ze ścianką wspinaczkową<br><span style="color:black;"> do godz. 12.00 - 90zł</span></p>
  ...
  <div  class=" col-xs-12 col-sm-12 col-md-6 col-lg-4">
     ...
     <!-- <p style="font-family: 'Pragati Narrow', sans-serif; color:white; font-size: 30px; text-align: center; margin-top:22px;">Posiadacze karty Benefit Multisport ćwiczą bez dodatkowych opłat.
      ...
      <p  style="font-family: 'Pragati Narrow', sans-serif; color:white; font-size: 32px; text-align: center; margin-top:22px;"> <strong>Niedziela, karnet rodzinny - wstęp jednorazowy - 30zł za całą rodzinę.<br>

Jeżeli twoje dziecko ćwiczy w Bastionie sporty walki - 50 zł siłownia open dla Ciebie. </strong></p>
