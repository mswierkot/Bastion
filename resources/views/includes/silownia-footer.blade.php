            ...
            <div class="row">
                ...
                <div  style="border-left: 1px solid rgb(52,52,52);"    class="col-sm-2">
                    ...
                    <ul>
                        ...
                        <li><a class="cool-link" href="{{ url('silownia-multimedia') }}">Multimedia</a></li>
                        <li><a class="cool-link" href="{{ url('silownia-kontakt') }}">Kontakt</a></li>
                        <li><a class="cool-link" href="{{ url('silownia-aktualnosci') }}">Aktualności Bastion</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
